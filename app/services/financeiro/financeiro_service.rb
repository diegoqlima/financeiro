module Financeiro
  class FinanceiroService
    ...
    def self.criar_evento_financeiro(valor, inicio, fim, tipo_evento_financeiro, meio_pagamento, periodo_cobranca, association_id, association_class)
      ef = Financeiro::FinanceiroService.find_evento_financeiro(association_id, association_class)
      if ef.present?
        ef.update_attributes({valor: valor, inicio: inicio, fim: fim, tipo_evento_financeiro: tipo_evento_financeiro, meio_pagamento: meio_pagamento, periodo_cobranca: periodo_cobranca})
      else
